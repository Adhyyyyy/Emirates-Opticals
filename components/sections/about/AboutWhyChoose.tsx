...
import { ShieldCheck, Eye, UserCheck, MapPin, HeartHandshake, Wrench } from "lucide-react";

const WHY_CHOOSE = [
  {
    icon: ShieldCheck,
    title: "100% Authentic Brands",
    desc: "Every frame and sunglass is sourced only directly from authorized brand houses, ensuring absolute genuine quality."
  },
  {
    icon: Eye,
    title: "Advanced Diagnostics",
    desc: "Equipped with state-of-the-art optical diagnostic technology and operated by highly qualified resident optometrists."
  },
  {
    icon: UserCheck,
    title: "Haute Styling Guidance",
    desc: "Personalized aesthetic recommendations tailored to your unique facial geometry, skin tone, and personal style."
  },
  {
    icon: HeartHandshake,
    title: "Premium Experience",
    desc: "A boutique showroom atmosphere designed around ultimate personal comfort, bespoke care, and complete trust."
  },
  {
    icon: MapPin,
    title: "Multi-Boutique Network",
    desc: "Convenient and seamless access to premium optical care across ten beautiful physical showrooms in Kerala."
  },
  {
    icon: Wrench,
    title: "After-Sales Concierge",
    desc: "Complimentary ultrasonic cleaning, frame alignment, repair services, and dedicated ongoing customer care."
  }
];
