...
const FEATURES = [
  "100% Certified UV Protection",
  "High-Contrast Polarized Lenses",
  "Precision Prescription Lenses",
  "Curated International Designers"
];

export function ServiceSunglasses() {
  return (
    <section className="w-full bg-[#FAF9F6] py-20 md:py-24 overflow-hidden border-t border-black/[0.03]" id="sunglasses-galleries">
      <div className="max-w-[1240px] mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 px-2">
            ...
            >
              Luxury <br />
              <em className="italic font-light font-serif text-brand-gold">Sunglass Galleries</em>
            </motion.h2>
            <motion.p
            ...
            >
              Protect your vision in style with authentic sunglasses handpicked from the runways of Paris, Milan, and New York, configured to fit your lifestyle perfectly.
            </motion.p>
          ...
          >
            <div className="relative w-full h-full overflow-hidden rounded-xl bg-neutral-100">
              <img
                ...
                alt="Luxury Sunglass Collection"
