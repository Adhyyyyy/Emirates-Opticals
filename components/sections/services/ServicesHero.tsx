...
export function ServicesHero() {
  return (
    <section className="hidden md:flex relative w-full h-[60vh] min-h-[480px] flex-col overflow-hidden bg-neutral-100 pt-24 md:pt-32" id="services-hero">
      {/* Crisp raw service hero background - no dimming masks or filters */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/Hero/service hero.webp"
