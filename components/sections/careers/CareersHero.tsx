...
export function CareersHero() {
  return (
    <section className="hidden md:flex relative w-full h-[60vh] min-h-[480px] flex-col overflow-hidden bg-neutral-100 pt-24 md:pt-32" id="careers-hero">
      {/* Crisp raw careers hero background - no dimming masks or filters */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/Hero/career herooo.webp"
          alt="Luxury Eyewear Careers"
          fill
