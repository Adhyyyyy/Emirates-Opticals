  ...
  return (
    <section className="w-full bg-white py-20 md:py-24 overflow-hidden text-neutral-900 border-t border-neutral-100">
      <div className="max-w-[1140px] mx-auto px-4 md:px-8">
        ...
        <div className="max-w-4xl mx-auto bg-[#FAF8F5] border border-neutral-200 p-12 md:p-20 rounded-2xl text-center relative overflow-hidden flex flex-col items-center">
