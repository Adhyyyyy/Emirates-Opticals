      ...
      <div className="container-tight relative z-10">
        ...
        <GridStagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {METHODS.map((item, idx) => (
            <StaggerItem key={idx}>
              <div className="bg-white p-10 border border-black/5 rounded-3xl hover:border-brand-gold/30 hover:shadow-xl transition-all duration-700 h-full flex flex-col group text-center items-center">
