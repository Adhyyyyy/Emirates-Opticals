        ...
        <div className="max-w-4xl mx-auto">
          <Reveal delay={0.2}>
            <span className="text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] text-brand-gold mb-8 block drop-shadow-md">
              Get In Touch With Emirates Optician
            </span>
          </Reveal>
          ...
          <Reveal delay={0.6}>
            <p className="text-sm md:text-lg text-white/80 font-light max-w-2xl mx-auto mb-16 leading-relaxed">
              Connect with Emirates Optician for professional eye care guidance, luxury eyewear assistance, appointment booking, and personalized customer support across Kerala.
            </p>
          </Reveal>
