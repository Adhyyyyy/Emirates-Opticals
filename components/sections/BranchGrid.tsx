...
const KERALA_BRANCHES = [
  {
    ...
    hours: "Tuesday: 9:30 AMâ€“7:30 PM",
        ...
        <div className="border-t border-neutral-100 pt-20">
          <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
            ...
            >
              <Link
                href="/book-eye-test"
                className="bg-neutral-900 text-white text-xs uppercase tracking-[0.15em] px-8 py-4 rounded-[3px] font-medium hover:bg-neutral-700 transition-all duration-200 inline-flex items-center justify-center gap-2"
              >
              ...
              <a
                href="tel:9682929968"
                className="border border-neutral-300 text-neutral-700 text-xs uppercase tracking-[0.15em] px-8 py-4 rounded-[3px] hover:border-neutral-900 transition-all duration-200 inline-flex items-center justify-center gap-2"
              >
